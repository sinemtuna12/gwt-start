...
public class CssView extends ViewImpl implements
		CssPresenter.MyView {

	private final Widget widget;

	public interface Binder extends UiBinder<Widget, CssView> {
	}
	...
	@Inject
	public CssView(final Binder uiBinder) {
	...
	public void setInSlot(Object slot, Widget content) {
		if (slot == CssPresenter.TYPE_SetTabContent) {
