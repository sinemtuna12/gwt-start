...
public class RowExpandGridView extends ViewImpl implements
		RowExpandGridPresenter.MyView {

	interface RowExpandRenderer extends XTemplates {
		@XTemplate(source = "stockdetail.html")
		public SafeHtml render(Stock data, String description);
	}
	private RowExpandRenderer renderer = GWT.create(RowExpandRenderer.class);
	
	private static final StockProperties props = GWT.create(StockProperties.class);
	public RowExpandGridView() {
	}
...
//		        sb.appendHtmlConstant("<p style='margin: 5px 5px 10px'><b>Summary:</b> " + desc);
		    	  sb.append(renderer.render(value, desc));
		      }
		    });
