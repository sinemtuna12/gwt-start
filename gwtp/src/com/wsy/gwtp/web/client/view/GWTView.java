...
public class GWTView extends ViewImpl implements GWTPresenter.MyView {

	private final Widget widget;

	public interface Binder extends UiBinder<Widget, GWTView> {
	}
	...
	@Inject
	public GWTView(final Binder uiBinder) {
	...
	public void setInSlot(Object slot, Widget content) {
		if (slot == GWTPresenter.TYPE_SetTabContent) {
