...
public class RemoteFilterGridView extends ViewImpl implements
		RemoteFilterGridPresenter.MyView {

	private final Widget widget;

	public interface Binder extends UiBinder<Widget, RemoteFilterGridView> {
	}
	public static StockProperties props = GWT.create(StockProperties.class);
	@Inject
	public RemoteFilterGridView(final Binder binder) {
		beforeBind();
	...
	private GridFilters<Stock> filters;
	...
	public void setLoader(
		...
		loader.addLoadHandler(new LoadResultListStoreBinding<FilterPagingLoadConfig, Stock, PagingLoadResult<Stock>>(
				store));
		...
		filters = new GridFilters<Stock>(loader);
