...
public class GXTTabView extends ViewImpl implements GXTTabPresenter.MyView {

	private final Widget widget;

	public interface Binder extends UiBinder<Widget, GXTTabView> {
	}
	...
	@Inject
	public GXTTabView(Binder uiBinder) {
	...
	public void setInSlot(Object slot, Widget content) {
		if (slot == GXTTabPresenter.TYPE_SetTabContent) {
