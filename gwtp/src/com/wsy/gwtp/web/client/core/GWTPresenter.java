...
public class GWTPresenter extends
		TabContainerPresenter<GWTPresenter.MyView, GWTPresenter.MyProxy> {

	public interface MyView extends TabView {
	}

	@ProxyCodeSplit
	@TabInfo(container = MainPagePresenter.class, label = "GWT", priority = TabPriorities.gwt, nameToken = NameTokens.cellRenderer)
	public interface MyProxy extends NonLeafTabContentProxy<GWTPresenter> {
	}
	...
	@Inject
	public GWTPresenter(final EventBus eventBus, final MyView view,
	...
	protected void onReset() {
		super.onReset();
		GWT.log("GWTPresenter.onReset() called.");
